...
Documentos legais de **Bunker Rush** (`com.bunkerrush.game`) — publicados via GitHub Pages.
...
2. A URL fica `https://caixeta94.github.io/BunkerRush-Legal/`

## URLs para a ficha da Play Store

| Campo do Play Console | URL |
|---|---|
| Política de Privacidade | `https://caixeta94.github.io/BunkerRush-Legal/privacidade.html` |
| Exclusão de conta (Data safety) | `https://caixeta94.github.io/BunkerRush-Legal/exclusao-de-conta.html` |
| Site do desenvolvedor | `https://caixeta94.github.io/BunkerRush-Legal/` |
...
- [ ] Os flags de feature em `games.json` batem com o que o app **realmente faz**
      (hoje: `local_ranking, crash_reports, analytics`). Data Safety divergente do comportamento real é a causa
